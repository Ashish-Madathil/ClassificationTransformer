...
def get_args(parser,eval=False):
    ...
    parser.add_argument('--dataset', type=str, choices=['coco', 'voc','coco1000','nus','vg','news','cub', 'blastocyst'], default='coco')
    parser.add_argument('--workers', type=int, default=10)
    parser.add_argument('--results_dir', type=str, default='results/')
    # parser.add_argument('--test_known', type=int, default=0)
    parser.add_argument('--test_known', type=int, default=3)
